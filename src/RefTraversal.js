...
export default class RefTraversal {
  constructor(ref, schema, rootType: string | Typed) {
    ...
    if (rootType) {
      ...
      this._schemaTraversal = new SchemaTraversal(schema, refSchema.id + ':Root');
    } else {
  ...
  get pathElem() { return this._ref.path.get(this._index); }
  get ref() { return this._ref.withPath(this._ref.path.slice(0, this._index + 1)); }
  get name() { return this.pathElem && this.pathElem.name; }
  get args() { return this.pathElem && this.pathElem.args; }
  get type() { return this._schemaTraversal.getCurrentType(); }
  // get paramsType() { return this._schemaTraversal.getParamsType(); }
  get schema() { return this._schemaTraversal.getCurrentSchema(); }
  get isRef() { return this._schemaTraversal.isRef(); }
  get isList() { return this._schemaTraversal.isList(); }
  get wrappers() { return this._schemaTraversal.getWrappers(); }
  get typed() { return this._schemaTraversal.getTyped(); }
  get fullTypeName() { return this._schemaTraversal.fullTypeName; }
  get paramsFullTypeName() { return this._schemaTraversal.paramsFullTypeName; }
  get member() { return this._schemaTraversal.member; }
  get schemaTraversal() { return this._schemaTraversal.clone(); }
}
